  ...
  return (
    <div>
      ...
      <div className="absolute">
        <img
          className="fixed h-screen object-cover w-full"
      ...
      <form
        ...
        className="w-10/12 md:w-2/6 absolute p-12 bg-gray-950/80 my-48 md:my-32 mx-auto right-0 left-0 text-white rounded-lg"
      >
